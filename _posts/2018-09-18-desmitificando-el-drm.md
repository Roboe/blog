...
- El ya comentado caso de traspasar un libro con DRM de un lector a otro. _No vaya a ser_ que lo vuelvas a leer sin pagar.
...
- Reproducir una película con DRM en alta resolución por la que has pagado en tu televisión, desde tu portátil, mediante un cable HDMI. Algunas películas de plataformas como Google Play Movies reducen su calidad si detectan que está siendo transmitida por cable. _No vaya a ser_ que quieras verla en una pantalla más grande sin pagar por una televisión con Android TV o un _dongle_ Chromecast.
- Jugar un juego con DRM sin conexión activa y permanente a internet. _No vaya a ser_ que quieras jugar sin que el vendedor del juego controle todas tus conexiones.
...
Cartuchos de impresoras que solo puede proveerte el mismo fabricante, imposibilidad de **arreglar** la radio del sistema empotrado con DRM de tu coche&hellip; la lista es interminable.
